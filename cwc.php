...
<nav class="navbar navbar-expand-sm   navbar-light bg-light">
    ...
    <main>
        <section class="subsection">
            <div class="container">
                <h2>Cricket World Cup 2023 Replica Shirts</h2>
                <div class="product-grid">
                <?php
                include 'config.php'; // Include your database connection configuration

                $stmt = $conn->prepare('SELECT DISTINCT product_name, product_price, product_image, product_code, id FROM cwc'); // Replace 'products' with your actual table name
                $stmt->execute();
