...
<body>
    ...
    <main>
        <section class="subsection">
            <div class="container">
                <h2>Pakistan Shirts</h2>
                <div class="product-grid">
                <?php
                include 'config.php'; // Include your database connection configuration

                $stmt = $conn->prepare('SELECT DISTINCT product_name, product_price, product_image, product_code, id FROM pak'); // Replace 'products' with your actual table name
                $stmt->execute();
                ...
                <div class="product">
                    ...
                    <form action="cartconfig.php" method="post" class="form-submit">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-6">
                                <b> Size: </b>
<select name="product_size" class="form-control mx-auto d-block">
